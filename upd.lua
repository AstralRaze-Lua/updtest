...
if enable_autoupdate then
    ...
    if updater_loaded then
        ...
        if autoupdate_loaded then
            Update.json_url = "https://raw.githubusercontent.com/AstralRaze-Lua/updtest/refs/heads/main/upd.json" .. tostring(os.clock())
            Update.prefix = "[" .. string.upper(thisScript().name) .. "]: "
            Update.url = "https://github.com/AstralRaze-Lua/updtest/tree/main/"
        end
    end
end
...
function main()
    ...
    sampRegisterChatCommand('upd', function()
        sampAddChatMessage('Checking update!', -1)
    end)
